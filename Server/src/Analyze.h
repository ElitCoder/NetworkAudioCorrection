...
namespace nac {
	...
	std::pair<std::vector<double>, std::pair<double, double>> fitBands(const FFTOutput& input, const std::pair<std::vector<double>, double>& eq_settings, bool input_db, const std::vector<int>& ignore_bands = std::vector<int>());
